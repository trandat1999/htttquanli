...
SELECT * FROM (SELECT 'admin' as created_by, 'admin' as last_modified_by, '$2y$10$L1PZpGhYShaAzbdxeuTj9.Sf99byWcmSCbVerHKXV.WO6GSOjDQGq' as password, 'admin' as username, 1 as role) AS tmp
WHERE NOT EXISTS (
